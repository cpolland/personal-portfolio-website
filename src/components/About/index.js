      ...
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            California San Diego UCSD. I studied full-stack web-dev but mainly
            focus on front-end development due to my love for design. I am
            knowledgable of both UI/UX Design. I am efficient in HTML, CSS,
            JavaScript, React, WordPress and I am familiar with a wide range of
            programs on the back-end. I love learning new programming languages
            and frame works when need be!
            <br></br>
            <br></br>
            ...
            the creative process and the satisfaction of a finished product. My
            hobbies include crocheting, illustration, photography, sound design,
            sewing, and many more. I consider myself to be an extremely
            compassionate person and I connect with pretty much anyone who wants
            to connect with me. When I am not coding or crafting, you can find
            me spending time with my boyfriend and my dog Riley.
            <br></br>
            <br></br>
